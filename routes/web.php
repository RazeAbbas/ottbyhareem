...
// });
    ...
    Route::prefix('dashboard')->group(function () {
        ...
        Route::middleware(['can:isManager'])->group(function(){
            ...
            Route::get('/receipts/print/{id?}','ReceiptController@print')->name('receipts.print');;
            Route::get('/receipts/create','ReceiptController@create');
            Route::post('/receipts/create','ReceiptController@create');
            Route::get('/receipts/edit/{id?}','ReceiptController@update');
            Route::post('/receipts/edit/{id?}','ReceiptController@update');
            Route::get('/receipts/delete/{id?}','ReceiptController@delete');
