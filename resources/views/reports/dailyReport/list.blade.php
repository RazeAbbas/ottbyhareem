         ...
         <table class="table">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td data-id="{{ $val['id'] }}" data-input="text" data-field="label">Rs.
                     {{ $val['total_bill'] }}
                  </td>
               </tr>
               @endforeach
            ...
            <tbody>
               ...
               <tr>
                  <td colspan="8" align="center">
                     ...
                     <strong>No {{ $module['singular'] }} found !</strong>
                  </td>
               </tr>
               @endif
            </tbody>
         ...
         <table class="table">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td data-id="{{ $val['id'] }}" data-input="text" data-field="label">
                     <strong>Employee Name</strong> {{ $val['getEmployee']->first_name }}
                     {{ $val['getEmployee']->last_name }}<br>
               ...
               <tr>
                  <td colspan="2"></td>
                  <td><strong>Total Outgoing</strong>
                     {{ $total_supplier_payment + $total_payment + $total_miscellaneous + $total_expense }}
                  </td>
               </tr>
            </tbody>
         </table>
